...
class JsPivotAggFnc(object):
  """
  :category: Base Aggregator class
  :rubric: JS
  :type: System
  :dsc:
  ...
  def toJs(self, options):
    """
    :category: Aggregator conversion
    :rubric: JS
    :type: System
    :dsc:
    ...
    :return: A String with the Javascript definition of an aggregator
    """
    jsPivot = ["tmpVal: 0"]
...
class JsPivotSumAgg(JsPivotAggFnc):
  ...
  :example: aresObj.pivot(df, rows=['Date'], cols=['direction'], valCol=['AAPL.Low'], aggOptions={'name': "Sum Agg", 'digits': 0})
  """
...
class JsPivotAbsSumAgg(JsPivotSumAgg):
  ...
  :example: aresObj.pivot(df, rows=['Date'], cols=['direction'], valCol=['AAPL.Low'], aggOptions={'name': "Abs Sum Agg", 'digits': 0})
  """
  name = "Abs Sum Agg"
...
class JsPivotMaxAgg(JsPivotSumAgg):
  ...
  :example: aresObj.pivot(df, rows=['Date'], cols=['direction'], valCol=['AAPL.Low'], aggOptions={'name': "Max Agg", 'digits': 0})
  """
  name = "Max Agg"
  keyAgg = '-Infinity'
...
class JsPivotMinAgg(JsPivotSumAgg):
  ...
  :example: aresObj.pivot(df, rows=['Date'], cols=['direction'], valCol=['AAPL.Low'], aggOptions={'name': "Min Agg", 'digits': 0})
  """
  name = "Min Agg"
  keyAgg = 'Infinity'
...
class JsPivotAvgAgg(JsPivotSumAgg):
  ...
  :example: aresObj.pivot(df, rows=['Date'], cols=['direction'], valCol=['AAPL.Low'], aggOptions={'name': "Avg Agg", 'digits': 0})
  """
  name = "Avg Agg"
  keyAgg = 0
...
class JsPivotDiff(JsPivotAggFnc):
  ...
  :example: aresObj.pivot(df, rows=['Date'], cols=['direction'], valCol=['AAPL.Low'], aggOptions={'name': "diff Agg", 'digits': 0})
  """
  name = "diff Agg"
  keyAgg, key2Agg = 0, 0
...
class JsPivotDiffPct(JsPivotDiff):
  ...
  :example: aresObj.pivot(df, rows=['Date'], cols=['direction'], valCol=['AAPL.Low'], aggOptions={'name': "diff Pct Agg", 'digits': 0})
  """
  name = "diff Pct Agg"
...
class JsPivotDiffAbs(JsPivotDiff):
  ...
  :example: aresObj.pivot(df, rows=['Date'], cols=['direction'], valCol=['AAPL.Low'], aggOptions={'name': "diff Abs Agg", 'digits': 0})
  """
  name = "diff Abs Agg"
...
class JsPivotDiffPctAbs(JsPivotDiff):
  ...
  :example: aresObj.pivot(df, rows=['Date'], cols=['direction'], valCol=['AAPL.Low'], aggOptions={'name': "diff Abs Pct Agg", 'digits': 0})
  """
...
class JsPivotSumOverSumAgg(JsPivotDiff):
  ...
  :example: aresObj.pivot(df, rows=['Date'], cols=['direction'], valCol=['AAPL.Low'], aggOptions={'name': "sum Over Sum Agg", 'digits': 0})
  """
