...
class JsPlotlyPie(object):
  """
  :category: RecordSet to Plotly Object
  :rubric: JS
...
class JsPlotly3D(object):
  """
  :category: Plotly Transformer
  :rubric: JS
  :type: Configuration
  :dsc:
    Convert the recordset to a Plotly object which can be used in 3d surface charts
  :example: aresObj.chart('surface-contours', df1, seriesNames=['col2'], xAxis='col4', otherDims=['col3'])
  """
  alias = "Plotly"
...
class JsPlotlyScatter3D(object):
  ...
  :dsc:
    Convert the recordset to a Plotly object which can be used in 3d surface charts
  :example: aresObj.chart('surface-contours', df1, seriesNames=['col2'], xAxis='col4', otherDims=['col3'])
  :example: aresObj.chart('mesh3d', df1, seriesNames=['col2', 'col3'], xAxis='col4', otherDims=['col5'], height=600)
  """
  alias = "Plotly"
...
class JsPlotlyMaps(object):
  ...
  :map ares.Lib.js.objects.jsChartPlotly.CTY: Available Country Names
  :example: aresObj.chart('europe', df1, seriesNames=['col2'], xAxis='col5')
  :example: aresObj.chart('choropleth', df1, seriesNames=['col2'], xAxis='col5')
  """
  alias = "Plotly"
...
class JsPlotlyHeatmap(object):
  ...
  :example: aresObj.chart('heatmap', df1, seriesNames=['col2', 'col3'], xAxis='col4')
  """
  alias = "Plotly"
  chartTypes = ['heatmap']
  params = ("seriesNames", "xAxis")
...
class JsPlotlyParCoordinates(object):
  ...
  :example: aresObj.chart('parcoords', df1, seriesNames=['col2', 'col3', 'col4'], xAxis='_index')
  """
  alias = "Plotly"
